...
<div id="wrap">
	...
	<!-- header -->
	<div id="header">
        <h1><a href="<?=_BASE_URI_?>/webmanager/page/main.html">예약박스 가맹점 관리자 모드</a></h1>
		...
		-->
		<li><a href="<?=_BASE_URI_?>/webmanager/member/modify_password.html"><strong>비밀번호변경</strong></a></li>
		<li><a href="<?=_BASE_URI_?>/webmanager/member/process.html?mode=logout&return_url=<?=urlencode('/webmanager/member/login.html')?>"><strong>로그아웃</strong></a></li>
        </ul>

        <a href="<?=$base_uri?>/reserve/dashboard.html" class="btn_cscenter" target="cscenter"><img src="<?=$layout_uri?>/img/btn/btn_inplus_customer.png" alt="예약캘린더" /></a>
        <div id="gnb">
            <ul>
			<?=$gnb?>			
            </ul>
