...
<div id="wrap">
	<!-- header -->
	<div id="header">
		<h1><a href="/webadmin"><img src="<?=$layout_uri?>/img/logo.jpg" alt="Reservation box" /></a></h1>
		...
		<div id="global">
			...
			<div class="logout">
				<p>
					<a href="<?=_BASE_URI_?>/webadmin/member/process.html?mode=logout&return_url=<?=urlencode('/webadmin/member/login.html')?>">
