...
if(sizeof($sv_id_arr) > 0) {
	...
	<li>
		...
		<li>
			<button type="button" onclick="removeSelectedService(this)"><i class="xi-close-circle"></i></button>
...
<div class="service_total">
	...
	<li>총 금액 <strong class="col_orange"><?=number_format($total_selected_price)?></strong>원</li>
	</ul>				
</div>