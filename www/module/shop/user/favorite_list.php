...
<div class="tab">
	...
	<li class="on"><a href="./favorite_list.html" <? if(!$is_user) { ?>class="btn_only_login"<? } ?>>즐겨찾기매장</a></li>
	<li><a href="./reserve_list.html" <? if(!$is_user) { ?>class="btn_only_login"<? } ?>>예약한 매장</a></li> 
