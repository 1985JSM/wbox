...
<div id="<?=$module?>">
	...
	<div class="list">
		...
		<tr class="list_tr_0">		
			...
			<td>2016.05.01</td>
			<td>2016.05.03</td>
			<td><a href="/webadmin/page/member_out_write.html" class="sButton tiny " title="수정">수정</a></td>
		</tr>
		...
		<div class="button">	
			<div class="left">
				<button type="submit" class="sButton small" title="탈퇴처리">탈퇴취소</button>
				<button type="submit" class="sButton small" title="즉시탈퇴처리">즉시탈퇴처리</button>
			</div>
			<div class="right">
