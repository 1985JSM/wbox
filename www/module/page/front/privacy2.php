...
<div id="page_wrap">
	<div id="page_contents">
    	<h1><img src="/img/title/tit02.png" alt="예약박스가맹점(담당자)정책" /></h1>
		<!-- 테스트 -->
		<!-- tab-->
		<div class="tab">		
			<ul class="tab_wrap1">
				...
				<li class="tab01">
					...
					<div class="tab_content sub01">
						...
						<div class="box">
							...
							<p>회원이 이용계약을 해지하고자 하는 때에는 회원 본인이 예약박스 가맹점관리자 웹 내의 "담당자삭제"메뉴를 이용해 가입 해지를 해야 합니다.<br />단, 서비스의 신청 등으로 포인트 등의 대가가 회원에게 지급된 경우 탈퇴 시 제한이 있을 수 있고, 적립된 포인트나 발행된 쿠폰은 복구되지 않습니다.</p>
						</div>
						...
						<div class="box">
							<p>이 약관은 2016년 07월 27일부터 변경/시행합니다.</p>
						</div>
					...
					<div class="tab_content sub02">
						...
						<div class="box">
							...
							<li>
								...
								<dl>
								<dt>필수항목</dt>
								<dd>아이디(ID), 비밀번호, 이름, 닉네임, 이메일주소 : 서비스 이용에 따른 본인 식별 절차에 이용, 가입연령 확인, 불량회원의 부정한 이용 재발 방지, 가입 및 가입횟수 제한 등 </dd>
						...
						<div class="box">
							...
							<li>② 개인정보 열람 및 정정을 하고자 할 경우에 수정 버튼을 클릭한 후 열람하거나 입력사항을 수정하여 정정하실 수 있습니다.</li>
							</ul>
						</div>
						...
						<div class="box">
							...
							<p>
							이용자는 개인정보의 수집, 이용 및 제공에 대해 동의한 내용을 언제든지 철회할 수 있습니다. 동의철회(회원탈퇴)는 예약박스 가맹점관리자 웹에서 로그인한 후 [담당자]를 클릭하여 수정을 클릭 후 직접 삭제(회원탈퇴)를 하거나, 개인정보 관리책임부서 또는 고객관리부서로 서면, 전화 또는 전자우편(E-mail) 등으로 연락하시면 지체 없이 이용자의 개인정보를 파기하는 등 필요한 조치를 하겠습니다. 
							</p>
						</div>
						...
						<div class="box">
							<h3>제 12 조 ( 가맹점관리자웹 이용자 및 법정대리인의 권리와 그 행사방법 )</h3>
							<p>
							회사 가맹점관리자웹 이용자는 언제든지 등록되어 있는 자신의 개인정보를 조회하거나 수정할 수 있으며 가입해지를 요청할 수도 있습니다. 이용자들의 개인정보 조회, 수정을 위해서는'개인정보변경'(또는'회원정보수정'등)을 가입해지(동의철회)를 위해서는 담당자정보에서"수정"를 클릭하여 본인 확인 절차를 거치신 후 직접 열람, 정정 또는 탈퇴가 가능합니다. 
