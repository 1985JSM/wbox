		...
		<div class="send_area">
			...
			<div class="con_left">
				...
				<div class="phone">
					...
					<div class="btn_mms">
						<span class="btn_set mms"><a href="./ajax.char_figure.html" class="btn_ajax size_480x300" target="#layer_popup" title="특수문자">특수문자</a></span><span class="btn_set mms"><a href="./ajax.upload_img.html" class="center btn_ajax size_480x410" target="#layer_popup" title="이미지">이미지</a></span><span class="btn_set mms"><a href="./ajax.short_url.html" class="btn_ajax size_480x400" target="#layer_popup" title="짧은 URL">짧은주소</a></span>
					</div>
				</div>
				<!-- //phone -->
			...
			<div class="con_right">
				...
				<div class="tab_area">
					<ul>
					<li><a href="message_mms_direct.html" class="on">직접입력</a></li>
					<li><a href="message_mms_member.html">고객선택</a></li>
					</ul>
				</div>
				<!-- //tab -->
