...
#layer_content table.write_table tr td span.general{ text-decoration:line-through;}
#layer_content table.write_table tr td span.member { color:#ff0000; font-weight:600; padding-left:10px;}
#layer_content table.write_table.mgt_20 { margin-top:20px;}
#layer_content div.btn{ padding:30px 0 0 0; text-align:center;}
</style>
...
<div id="layer_popup" style="width: 700px; height: 720px; margin-top: -375px; margin-left: -350px; display: block;">
	<div id="layer_header">
		<h1><img src="/img/manager/h1_popup2.gif" alt="가맹점 예약등록 (미등록고객예약)"/></h1>
	...
	<div id="layer_content">
		...
		<tr>
			<th>미등록 고객</th>
			<td>
				<input name="text" type="text" class="text" size="6" />
				<input name="text" type="text" class="text" size="6" /> -
				<input name="text" type="text" class="text" size="6" /> -
				<input name="text" type="text" class="text" size="6" />
			</td>
		...
		<table border="1" class="write_table mgt_20">
		<colgroup>
		<col width="130">
		<col width="*">
		</colgroup>
		...
		<tr>
			<th>예약일자/시간</th>
			<td><strong>2015년 11월 05일 14:00</strong> <img alt="조회/변경" src="/img/manager/btn_change.gif"></td>
		</tr>
		<tr>
			<th>가격</th>
			<td><span class="general">일반가 5,000원</span> <span class="member">회원가 3,000원</span></td>
		</tr>
		<tr>
			<th>메모</th>
			<td><textarea class="textarea required" title="내용" cols="75" rows="3" name="nt_content"></textarea></td>
		</tr>
		</tbody>
		</table>
		<div class="btn">
			<img alt="비회원예약" src="/img/manager/btn_nomember.gif">
			<img alt="취소" src="/img/manager/btn_cancel.gif">
		</div>
