...
<div id="<?=$module?>">
	...
	<div class="list">
		...
		<tr class="list_tr_0">		
			...
			<td>남자</td>
			<td>닉네임은최대열글자</td>
			<td>smile@inplusweb.comsmile@inplusweb.comsmile@inplusweb.com</td>
			<td>0102345678</td>
			<td>브론즈</td>
			<td>전지현</td>
		...
		<tr>
			<td colspan="11" class="no_data">검색 결과가 없습니다.</td>
		</tr>
		</tbody>
		</table>	
		<!-- //list_table -->
		...
		<div class="button">	
			...
			<div class="right">
				<a href="/webmanager/page/member_write.html" class="sButton small primary" title="고객등록">고객등록</a>	
			</div>
		</div>
