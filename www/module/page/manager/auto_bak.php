...
<div id="<?=$module?>">
	...
	<div class="subWrap sub_auto write">
		<div class="info_box">
			...
			<li>- 자동SMS의 발송문구는 기본 제공됩니다. 각 기본 발송문구의 텍스트는 수정 가능하며, 치환코드를 사용하여 시스템상의 정보를 SMS에 포함할 수 있습니다. 아래 [치환코드 보기] 버튼 클릭 시 사용가능한 치환코드를 확인할 수 있습니다.
			<p><a href="#" class="sButton tiny">치환코드 보기</a></p>
			</li>
			</ul>
		</div>
		...
		<table class="list_table" summary="메시지 자동발송 설정에 관련된 표로써 전송내용, 설명, 설정 순으로 출력됩니다.">
		...
		<tr>
			<td>
				...
				<span class="help"><img src="/img/manager/ico_tip_notice.png" alt="도움말 아이콘" /> 메세지 전송 내용 수정이 불가합니다.</span>	
			</td>
			<td>				
				<div class="write_area">
