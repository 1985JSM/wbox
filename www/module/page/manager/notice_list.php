...
<div id="notice">
	...
	<div class="list">
		...
		<tr class="list_tr_0">		
			...
			<td>3</td>
			<td class="subject"><a href="notice_view.html">SMS(문자)서비스 안내</a></td>			
			<td>2016.07.28</td>
		</tr>
		<tr class="list_tr_1">		
			<td><input type="checkbox" name="" value="" class="list_check" title="선택/해제" /></td>
			<td>3</td>
			<td class="subject"><a href="notice_view.html">클라이언트 2.2.5 버전 출시 안내</a></td>			
			<td>2016.07.28</td>
		</tr>
		<tr class="list_tr_0">		
			<td><input type="checkbox" name="" value="" class="list_check" title="선택/해제" /></td>
			<td>3</td>
			<td class="subject"><a href="notice_view.html">2016년 7월 정기 PM 공지</a></td>			
			<td>2016.07.28</td>
		</tr>				
		</tbody>
		</table>	
		...
		<div class="button">	
			...
			<div class="right">
				<a href="notice_write.html" class="sButton small primary" title="등록하기">등록하기</a>	
			</div>
		</div>
		</form>
