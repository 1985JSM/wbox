...
<div id="faq">
	...
	<div class="list">
		...
		<tr class="list_tr_0">	
			...
			<td>6</td>	
			<td>카테고리1</td>	
			<td class="subject"><a href="faq_view.html">크롬에서 상품(콘텐츠) 상세보기 팝업의 내용이 깨져 보여요!</a></td>	
			<td>2016.08.09</td>
			<td>61</td>
		</tr>
		<tr class="list_tr_1">	
			...
			<td>5</td>	
			<td>카테고리2</td>	
			<td class="subject"><a href="faq_view.html">콘텐츠에 사용된 폰트는 어떻게 사용할 수 있나요?</a></td>	
			<td>2016.08.09</td>
			<td>66</td>
		</tr>
		<tr class="list_tr_0">	
		...
		<div class="button">	
			...
			<div class="right">
				<a href="faq_write.html" class="sButton small primary" title="등록하기">등록하기</a>	
			</div>
		</div>
