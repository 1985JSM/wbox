...
<div id="<?=$module?>">
	...
	<div class="subWrap sub_result write">		
		<p class="guide_txt"><strong class="info"><i class="xi-comment xi-x"></i></strong> 메시지 충전하신 내역입니다.</p>			
		...
		<tr>
			<th>휴대폰</th>
			<td class="left">01012345678</td>
		</tr>
		<tr>
			<th>이메일</th>
			<td class="left">inplus@inplusweb.com</td>
		</tr>							
		</tbody>
		</table>
		...
		<tr>
			<th>결제금액</th>
			<td><strong class="primary">110,000 원</strong></td>
		</tr>
		</tbody>
		</table>
		</fieldset>
		...
		<p class="button">
			<a href="message_sms_direct.html" class="sButton large info">메시지전송</a>
		</p>
