...
#dashboard_calendar table.month_table { border-collapse:collapse; table-layout:fixed; border:0; border-top:1px solid black; margin-bottom:100px; }
...
#dashboard_calendar table.week_table { border-collapse:collapse; table-layout:fixed; border:0; border-top:1px solid black; }
#dashboard_calendar table.week_table tr th, #dashboard_calendar table.week_table tr td { height:40px; line-height:40px; text-align:center; font-weight:bold; border:0; border-left:1px solid black; }
#dashboard_calendar table.week_table tr th { background:
