...
<div id="container" class="container">
	<div class="member_join">
		...
		<li>
			...
			<li>
				<div>
					<input type="date" name="mb_birth" class="input_txt input_date required" placeholder="생년월일" title="생년월일">                   
				</div>
			</li>
			<li>
				<div>
		...
		<li>
			...
			<input type="text" name="mb_nick" id="mb_nick" class="input_txt required" placeholder="최대 10자 이내로 입력해주세요." maxlength="10" title="닉네임">
		...
		<li>
			...
			<li>
				...
				<button type="button" class="agree_view_detail">자세히보기 <i class="xi-angle-right"></i></button>
				<div>
