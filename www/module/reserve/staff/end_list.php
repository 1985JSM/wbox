...
$cnt_arr = array(
	'E'	=> $oReserve->countByStaffId($member['mb_id'], 'E'),
	'C'	=> $oReserve->countByStaffId($member['mb_id'], 'C'),
	'B'	=> $oReserve->countByStaffId($member['mb_id'], 'B')
);
$cnt_arr['total'] = $cnt_arr['E'] + $cnt_arr['C'] + $cnt_arr['B'];
?>
<style type="text/css">
...
$(document).ready(function() {
	...
	// 상태 검색
	$("#sch_rs_state").on("change", function() {
...
<div class="tab">
	...
	<li><a href="../reserve/wait_list.html">진행중인 예약</a></li>
	<li class="on"><a href="../reserve/end_list.html">종료된 예약</a></li>
	</ul>
</div>    
...
<div id="container" class="container">
	<div class="reservation2">
		<div class="res2_list">
			<h4>
				누적 총 <span class="col_orange"><?=number_format($cnt_arr['total'])?></span>건 
				<span class="txt">완료 <span class="col_orange"><?=number_format($cnt_arr['E'])?></span>건, 
				정상취소 <span class="col_black"><?=number_format($cnt_arr['C'])?></span>건, 
				비정상취소 <span class="col_black"><?=number_format($cnt_arr['B'])?></span>건</span>
			</h4>

			<form name="search_form" method="get" action="./end_list.html" onsubmit="return submitSearchForm(this)">
			<input type="hidden" name="page" value="1" />
			<input type="hidden" name="sch_type" value="all" />

			<ul class="list_search">
			<li>
				<select name="sch_rs_state" id="sch_rs_state">
			...
			<li>
				<div class="list_search_form">
					<div class="list_search_input"><input type="text" name="sch_keyword" value="<?=$sch_keyword?>" class="input_txt" placeholder="이름/휴대폰 검색" title="이름 또는 휴대폰" /></div>
...
<input type="hidden" name="sch_rs_state"		value="<?=$sch_rs_state?>" />
</form>
