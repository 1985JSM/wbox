...
<div class="list_top">
	...
	<div class="notice_right">
		...
		<div class="popup_search">
			<form name="search_form" action="<?=$base_uri?>/notice/list.html" method="get" onsubmit="return submitSearchForm(this)" target="#layer_content">
...
<div class="list">
	...
	<tr class="list_tr_<?=$list[$i]['odd']?>">				
		<td><?=$list[$i]['no']?></td>
		<td class="subject"><a href="<?=$base_uri?>/notice/view.html?<?=$pk?>=<?=$list[$i][$pk]?>&page=<?=$page?><?=$query_string?>" class="btn_ajax" target="#layer_content"><?=$list[$i]['bo_subject']?></a></td>			
	...
	<div class="pagination">
		<ul>
		<? printAjaxPagination($page_arr, $query_string, $base_uri.'/notice/list.html', '#layer_content'); ?>
		</ul>
	</div>
	<!-- //pagination -->
</div>
