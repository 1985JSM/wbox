...
$bo_display_arr = $oNotice->get('bo_display_arr');
?>
...
<div id="<?=$module?>">
	...
	<div class="search">
		...
		<tr>
			<th>출력유형</th>
			<td>
				<select name="sch_bo_display" class="select" title="출력구분">
				<option value="">전체</option>
				<? printSelectOption($bo_display_arr, $sch_bo_display, 1); ?>
				</select>					
			</td>
		</tr>
		</tbody>
