...
<div id="<?=$module?>">
	...
	<div class="write">
		...
		<input type="hidden" name="df_nick" value="<?=$data['mb_nick']?>" />
		...
		<tr>
			...
			<td>			
				<input type="text" name="mb_nick" id="mb_nick" value="<?=$data['mb_nick']?>" class="text required" size="20" maxlength="10" title="닉네임" />
				<input type="hidden" name="chk_mb_nick" value="0" />
				<span id="state_mb_nick"></span>			
			</td>
		</tr>
		<?
		...
		<tr>
			...
			<td>
				...
				<br />
				<span class="comment">- 근무시간 중 정기적인 휴식 시간을 입력바랍니다. <strong class="info">해당 시간은 예약이 불가능</strong>합니다. (예.점심시간 12:00~13:00)</span>
			</td>
		</tr>
		<tr>
		...
		*/
		...
		<br />
		<span class="comment">- 1회성 또는 특정기간 부재시 입력바랍니다. <span class="info">해당 일자 및 시간은 예약이 불가능</span>합니다.</span>
		</fieldset>
