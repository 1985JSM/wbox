...
$reserve_std_arr = $oStats->get('reserve_std_arr');
if(!$std_type) {
	$std_type = 'month';
}

$stats = $oStats->selectUserReserveStats($std_type);
...
<div id="<?=$module?>">
	...
	<!-- search -->
	<div class="search">
		<form name="search_form" action="./user_reserve.html" method="get" onsubmit="return submitSearchForm(this)">
		...
		<tr>
			<th>집계기준</th>
			<td>
				<? printRadio('std_type', $reserve_std_arr, $std_type, 1); ?>
			</td>
		</tr>
		</tbody>
		</table>
		...
		<p class="button">		
			...
			<a href="./user_reserve.html" class="sButton" title="초기화">초기화</a>
		</p>
		</form>
	</div>
	<!-- //search -->
	...
	<div class="stats">
		<h4>
			<strong class="info"><?=$reserve_std_arr[$std_type]?></strong> 
			<strong>예약현황</strong> 
