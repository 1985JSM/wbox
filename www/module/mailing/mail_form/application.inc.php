...
$to_mail = $arr['ap_email'];
$to_name = $arr['ap_name'];
$subject = '['._HOMEPAGE_TITLE_.'] 가맹점 등록 이메일 인증';
?>
  ...
  <TBODY>
    <TR>
      <TD style="BORDER-BOTTOM: 0px; BORDER-LEFT: 0px; PADDING-BOTTOM: 5px; PADDING-LEFT: 15px; PADDING-RIGHT: 15px; BORDER-TOP: 0px; BORDER-RIGHT: 0px; PADDING-TOP: 5px"><TABLE style="BORDER-BOTTOM: #ddd 1px solid; BORDER-LEFT: #ddd 1px solid; BACKGROUND-COLOR: #fff; WIDTH: 100%; BORDER-COLLAPSE: collapse !important; BORDER-TOP: #ddd 1px solid; BORDER-RIGHT: #ddd 1px solid">
          <TBODY>
            <TR>
              <TD style="TEXT-ALIGN: right; HEIGHT:100px; padding-top:20px; padding-right:20px;"><IMG style="BORDER-BOTTOM: 0px; BORDER-LEFT: 0px; BORDER-TOP: 0px; BORDER-RIGHT: 0px" alt=""<?=_HOMEPAGE_TITLE_?>" align=absMiddle src="http://<?=_HOMEPAGE_DOMAIN_?>/img/mailing//mailLogo.jpg"></TD>
            </TR>
            <TR>
              <TD style="TEXT-ALIGN: center; PADDING-BOTTOM: 30px; PADDING-LEFT: 20px; PADDING-RIGHT: 20px; PADDING-TOP:0px"><!-- 내용 : S -->
                <TABLE style="WIDTH: 100%; BORDER-COLLAPSE: collapse !important">
                  <TBODY>
                    <TR>
                      <TD style="FONT-FAMILY: Dotum,돋움;BORDER-BOTTOM: 1px #e5e5e5 solid; TEXT-ALIGN:left; BORDER-LEFT: 0px; PADDING-BOTTOM:10px; PADDING-LEFT: 10px; PADDING-RIGHT: 10px;  COLOR: #000000; FONT-SIZE: 12pt; BORDER-TOP: 0px; FONT-WEIGHT: bold; BORDER-RIGHT: 0px; PADDING-TOP: 10px">가맹점 등록 이메일 인증</TD>
                    </TR>
                    <TR>
                    ...
                    <TR>
                      <TD style="TEXT-ALIGN: left; FONT-FAMILY: Dotum,돋움;BORDER-BOTTOM: 0px; BORDER-LEFT: 0px; PADDING-BOTTOM: 10px; PADDING-LEFT: 10px; PADDING-RIGHT: 10px;  COLOR: #575757; FONT-SIZE: 9pt; line-height:18px; BORDER-TOP: 0px; BORDER-RIGHT: 0px; PADDING-TOP: 20px"><SPAN style="COLOR: #575757; FONT-WEIGHT: bold">가맹점 등록을 완료하기 위해<br>이메일 인증을 해주세요.</SPAN><br><br><span style="color:#4f81bd; font-weight:bold;"><?=$to_name?>님</span>의 가맹점 등록 신청을 환영합니다. <br>[<?=_HOMEPAGE_TITLE_?>] 가맹점등록 신청을 완료하기 위해서는 이메일 인증과<br>가맹점 추가정보를 모두 작성하셔야 최종 승인이 완료됩니다.<br><br>아래의 가맹점 인증버튼을 클릭하시면 추가정보를 작성할 수 있습니다.<br>
                      </TD>
                    </TR>
            ...
            <TR>
              <TD align="center" style="BORDER-BOTTOM: 0px; BORDER-LEFT: 0px; PADDING-BOTTOM: 45px; PADDING-LEFT: 0px; PADDING-RIGHT: 0px; BORDER-TOP: 0px; BORDER-RIGHT: 0px; PADDING-TOP: 0px">
			  <a href="http://<?=_HOMEPAGE_DOMAIN_?>/webmanager/member/join.html?ap_code=<?=$arr['ap_code']?>" target="_blank"><IMG style="BORDER-BOTTOM: 0px; BORDER-LEFT: 0px; BORDER-TOP: 0px; BORDER-RIGHT: 0px" alt=가맹점인증 align=absMiddle src="http://<?=_HOMEPAGE_DOMAIN_?>/img/mailing//mailBtn1.gif"></a></TD>
            </TR>
            <TR>
